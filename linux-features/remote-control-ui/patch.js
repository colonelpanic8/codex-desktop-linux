  ...
  descriptors: [
    {
      ...
      order: 20500,
      ciPolicy: "optional",
      pattern: /^(?:remote-connection-visibility|app-initial~app-main~new-thread-panel-page~appgen-library-page~hotkey-window-thread-page~ho~glxlkd48)-.*\.js$/,
    ...
    },
    {
      ...
      order: 20510,
      ciPolicy: "optional",
      pattern: /^(?:remote-control-connections-visibility|remote-connection-visibility|app-initial~app-main~new-thread-panel-page~appgen-library-page~hotkey-window-thread-page~ho~iufn7mg3)-.*\.js$/,
