...
function buildPetOverlayMethods(settings) {
  return [
    ...
    "codexPetOverlayLayoutForDisplay(e,t,n){if(process.platform!==`linux`||t==null||t.windowBounds==null)return t;let r=this.codexPetOverlayDisplayRect(e),i=this.codexPetOverlaySettings(),a=t;if(i.lockPosition===!0&&r!=null){let e=this.codexPetOverlayGravityBounds(r,a,i);e!=null&&(a=this.codexPetOverlayLayoutAtWindowPosition(e,a))}else{let e=this.codexPetOverlayWindowBounds(n),o=!1;try{o=n?.isVisible?.()===!0}catch{}e!=null&&r!=null&&this.codexPetOverlayBoundsNearDisplay(e,r)&&(o||this.codexPetOverlayInitialPositionDone===!0||this.codexPetOverlayManualPosition===!0)?(this.codexPetOverlayInitialPositionDone=!0,this.codexPetOverlayMoved(e,a.windowBounds)&&(this.codexPetOverlayManualPosition=!0),a=this.codexPetOverlayLayoutAtWindowPosition(e,a)):this.codexPetOverlayInitialPositionDone=!0}return this.codexPetOverlayTrayAboveLeft(a)}",
    ...
    "codexPetOverlaySyncWindow(e){if(process.platform!==`linux`||e==null||e.isDestroyed?.())return;let t=this.codexPetOverlaySettings();try{e.setFocusable?.(t.mode!==`passive`)}catch{}try{t.skipTaskbar&&e.setSkipTaskbar?.(!0)}catch{}try{t.alwaysOnTop&&e.setAlwaysOnTop?.(!0)}catch{}try{e.setBackgroundColor?.(`#00000000`)}catch{}try{this.codexPetOverlayInstallTransparentRenderer(e)}catch{}try{e.setOpacity?.(1)}catch{}try{t.allWorkspaces&&e.setVisibleOnAllWorkspaces?.(!0,{visibleOnFullScreen:!0})}catch{try{t.allWorkspaces&&e.setVisibleOnAllWorkspaces?.(!0)}catch{}}try{e.moveTop?.()}catch{}try{this.codexPetOverlayScheduleHyprlandHints(e)}catch{}}",
    ...
    "codexPetOverlayHyprctl(e,t){try{let n=typeof require==`function`?require(`node:child_process`):null;if(n?.execFile==null){typeof t==`function`&&t(Error(`hyprctl unavailable`));return}n.execFile(`hyprctl`,e,{timeout:1200},(e,n)=>{typeof t==`function`&&t(e,n)})}catch(e){try{typeof t==`function`&&t(e)}catch{}}}",
    ...
    "codexPetOverlaySelectHyprlandClient(e,t){if(!Array.isArray(e))return null;let n=this.codexPetOverlayRect(t),r=[];for(let i of e){if(i==null||typeof i.address!=`string`||!/^0x[0-9a-f]+$/i.test(i.address)||i.floating!==!0||!(i.fullscreen===0||i.fullscreen===!1))continue;let t=i.size,a=i.at;if(!Array.isArray(t)||!Array.isArray(a))continue;let o=Number(t[0]),s=Number(t[1]),c=Number(a[0]),l=Number(a[1]),u=o*s;if(![o,s,c,l,u].every(Number.isFinite)||o<=0||s<=0||u>400000)continue;let d=Number(i.pid)===Number(process.pid),p=String(i.class??``).toLowerCase(),h=String(i.title??``).toLowerCase(),g=p.includes(`codex`)||h.includes(`codex`);if(!d&&!g)continue;let f=n==null?0:Math.abs(o-n.width)+Math.abs(s-n.height)+Math.abs(c-n.x)+Math.abs(l-n.y);r.push({client:i,score:f,samePid:d,nameMatch:g})}if(n!=null){let e=r.filter(e=>e.samePid&&e.score<=80);if(e.length===1)return e[0].client;if(e.length>1)return null;let t=r.filter(e=>e.nameMatch&&e.score<=80);return t.length===1?t[0].client:null}let i=r.filter(e=>e.samePid);return i.length===1?i[0].client:null}",
    ...
    "codexPetOverlayApplyHyprlandHints(e){if(process.platform!==`linux`||e==null||e.isDestroyed?.()||!this.codexPetOverlayShouldUseHyprland())return;this.codexPetOverlayFindHyprlandClient(e,t=>{let n=`address:${t.address}`;t.pinned!==!0&&this.codexPetOverlayHyprlandDispatch(`hl.dsp.window.pin({ action = \"on\", window = \"${n}\" })`,[`pin`,n]);this.codexPetOverlayHyprlandSetProp(n,`decorate`,`0`);this.codexPetOverlayHyprlandSetProp(n,`no_shadow`,`1`);this.codexPetOverlayHyprlandSetProp(n,`no_blur`,`1`);this.codexPetOverlayHyprlandSetProp(n,`no_anim`,`1`);this.codexPetOverlayHyprlandSetProp(n,`border_size`,`0`);this.codexPetOverlayHyprlandSetProp(n,`rounding`,`0`);this.codexPetOverlayHyprlandSetProp(n,`opacity`,`1.0 override 1.0 override 1.0 override`);this.codexPetOverlayHyprlandSetProp(n,`opaque`,`0`);this.codexPetOverlayHyprlandSetProp(n,`force_rgbx`,`0`);this.codexPetOverlayHyprlandDispatch(`hl.dsp.window.alter_zorder({ mode = \"top\", window = \"${n}\" })`,[`alterzorder`,`top,${n}`])})}",
    "codexPetOverlayScheduleHyprlandHints(e){if(!this.codexPetOverlayShouldUseHyprland())return;try{this.codexPetOverlayHyprlandTimers?.forEach(clearTimeout)}catch{}this.codexPetOverlayHyprlandTimers=[0,80,300,1000,2500,5000].map(t=>{let n=setTimeout(()=>{try{e==null||e.isDestroyed?.()||this.codexPetOverlayApplyHyprlandHints(e)}catch{}},t);try{n.unref?.()}catch{}return n})}",
  ].join("");
}
...
function patchShowWindow(source) {
  ...
  const replacement = `${needle}process.platform===\`linux\`&&this.codexPetOverlaySyncWindow(${windowArg}),`;
  return replaceMethodText(source, method, method.text.replace(needle, replacement));
}
