...
function linuxDesktopSettingsExtensionsSource() {
  return `var LinuxDesktopSettingsExtensions=[];function LinuxDesktopSettingsExtensionSlot({mode}){return $.jsx(React.Fragment,{children:LinuxDesktopSettingsExtensions.map((Extension,index)=>$.jsx(Extension,{mode},index))})}`;
}
