...
function buildLinuxBuildInfoHelpers(electronVar, fsVar, pathVar) {
  return `function codexLinuxBuildInfoPaths(){let __codexBuildInfoPaths=[];try{__codexBuildInfoPaths.push((0,${pathVar}.join)(process.resourcesPath,\`codex-linux-build-info.json\`)),__codexBuildInfoPaths.push((0,${pathVar}.join)(process.resourcesPath,\`..\`,\`.codex-linux\`,\`build-info.json\`))}catch{}return __codexBuildInfoPaths}
function codexLinuxReadBuildInfo(){for(let __codexBuildInfoPath of codexLinuxBuildInfoPaths())try{if(${fsVar}.existsSync(__codexBuildInfoPath)){let __codexBuildInfo=JSON.parse(${fsVar}.readFileSync(__codexBuildInfoPath,\`utf8\`));if(__codexBuildInfo&&typeof __codexBuildInfo===\`object\`&&!Array.isArray(__codexBuildInfo))return{info:__codexBuildInfo,path:__codexBuildInfoPath}}}catch{}return{info:null,path:null}}
function codexLinuxBuildInfoValue(__codexBuildInfoValue,__codexBuildInfoFallback=\`unknown\`){return typeof __codexBuildInfoValue===\`string\`&&__codexBuildInfoValue.trim().length>0?__codexBuildInfoValue:Array.isArray(__codexBuildInfoValue)&&__codexBuildInfoValue.length>0?__codexBuildInfoValue.join(\`, \`):__codexBuildInfoValue==null?__codexBuildInfoFallback:String(__codexBuildInfoValue)}
function codexLinuxBuildInfoCommitUrl(__codexBuildInfo){let __codexBuildInfoCommitUrl=__codexBuildInfo?.source?.commitUrl;return typeof __codexBuildInfoCommitUrl===\`string\`&&/^https:\\/\\/github\\.com\\/[^/\\s]+\\/[^/\\s]+\\/commit\\/[0-9a-f]{7,40}$/i.test(__codexBuildInfoCommitUrl)?__codexBuildInfoCommitUrl:null}
function codexLinuxGetBuildInfo(){let __codexBuildInfoResult=codexLinuxReadBuildInfo();return{...__codexBuildInfoResult,commitUrl:codexLinuxBuildInfoCommitUrl(__codexBuildInfoResult.info)}}
function codexLinuxBuildInfoDetail(__codexBuildInfo,__codexBuildInfoPath){if(!__codexBuildInfo)return\`No Linux build metadata file was found in this app install.\`;let __codexBuildInfoTarget=__codexBuildInfo.linuxTarget??{},__codexBuildInfoDistro=__codexBuildInfoTarget.distro??{},__codexBuildInfoDmg=__codexBuildInfo.upstreamDmg??{},__codexBuildInfoSource=__codexBuildInfo.source??{},__codexBuildInfoFeatures=__codexBuildInfo.linuxFeatures?.enabled??[],__codexBuildInfoProfile=__codexBuildInfo.packageProfile??{},__codexBuildInfoCommit=__codexBuildInfoSource.commit||__codexBuildInfoSource.shortCommit,__codexBuildInfoCommitValue=__codexBuildInfoCommit?__codexBuildInfoSource.dirty?\`\${__codexBuildInfoCommit} (dirty)\`:__codexBuildInfoCommit:\`unknown\`,__codexBuildInfoDistroValue=__codexBuildInfoDistro.prettyName||[__codexBuildInfoDistro.id,__codexBuildInfoDistro.versionId].filter(Boolean).join(\` \`)||\`unknown\`,__codexBuildInfoCommitLink=codexLinuxBuildInfoCommitUrl(__codexBuildInfo);return[\`Metadata file: \${codexLinuxBuildInfoValue(__codexBuildInfoPath)}\`,\`Linux package profile: \${codexLinuxBuildInfoValue(__codexBuildInfoProfile.label)}\`,\`Distro: \${__codexBuildInfoDistroValue}\`,\`Package manager: \${codexLinuxBuildInfoValue(__codexBuildInfoTarget.packageManager??__codexBuildInfoProfile.packageManager)}\`,\`Package format: \${codexLinuxBuildInfoValue(__codexBuildInfoTarget.packageFormat??__codexBuildInfoProfile.format)}\`,\`Enabled features: \${__codexBuildInfoFeatures.length>0?__codexBuildInfoFeatures.join(\`, \`):\`none\`}\`,\`Upstream app version: \${codexLinuxBuildInfoValue(__codexBuildInfoDmg.appVersion)}\`,\`Upstream DMG SHA256: \${codexLinuxBuildInfoValue(__codexBuildInfoDmg.sha256)}\`,\`Electron: \${codexLinuxBuildInfoValue(__codexBuildInfo.electronVersion)}\`,\`Linux source commit: \${__codexBuildInfoCommitValue}\`,\`Commit message: \${codexLinuxBuildInfoValue(__codexBuildInfoSource.commitMessage)}\`,...(__codexBuildInfoCommitLink?[\`Source commit URL: \${__codexBuildInfoCommitLink}\`]:[]),\`Source branch: \${codexLinuxBuildInfoValue(__codexBuildInfoSource.branch)}\`,\`Generated: \${codexLinuxBuildInfoValue(__codexBuildInfo.generatedAt)}\`].join(\`\\n\`)}
function codexLinuxEscapeBuildInfoHtml(__codexBuildInfoValue){return String(__codexBuildInfoValue??\`\`).replace(/[&<>\"']/g,__codexBuildInfoCharacter=>({"&":\`&amp;\`,"<":\`&lt;\`,">":\`&gt;\`,"\\\"":\`&quot;\`,"'":\`&#39;\`})[__codexBuildInfoCharacter])}
function codexLinuxBuildInfoHtmlRow(__codexBuildInfoLabel,__codexBuildInfoValue,__codexBuildInfoHref){let __codexBuildInfoContent=__codexBuildInfoHref?\`<a href="\${codexLinuxEscapeBuildInfoHtml(__codexBuildInfoHref)}" target="_blank" rel="noreferrer">\${codexLinuxEscapeBuildInfoHtml(__codexBuildInfoValue)}</a>\`:\`<code>\${codexLinuxEscapeBuildInfoHtml(__codexBuildInfoValue)}</code>\`;return\`<dt>\${codexLinuxEscapeBuildInfoHtml(__codexBuildInfoLabel)}</dt><dd>\${__codexBuildInfoContent}</dd>\`}
function codexLinuxBuildInfoDocument(__codexBuildInfoResult){let __codexBuildInfo=__codexBuildInfoResult.info,__codexBuildInfoPath=__codexBuildInfoResult.path;if(!__codexBuildInfo)return\`<!doctype html><meta charset="utf-8"><title>Build Information</title><style>body{font:14px system-ui,sans-serif;margin:28px;color:#202124;background:#fff}@media(prefers-color-scheme:dark){body{color:#e8eaed;background:#202124}}</style><h1>Build Information</h1><p>No Linux build metadata file was found in this app install.</p>\`;let __codexBuildInfoTarget=__codexBuildInfo.linuxTarget??{},__codexBuildInfoDistro=__codexBuildInfoTarget.distro??{},__codexBuildInfoDmg=__codexBuildInfo.upstreamDmg??{},__codexBuildInfoSource=__codexBuildInfo.source??{},__codexBuildInfoFeatures=__codexBuildInfo.linuxFeatures?.enabled??[],__codexBuildInfoProfile=__codexBuildInfo.packageProfile??{},__codexBuildInfoCommit=__codexBuildInfoSource.commit||__codexBuildInfoSource.shortCommit,__codexBuildInfoCommitValue=__codexBuildInfoCommit?__codexBuildInfoSource.dirty?\`\${__codexBuildInfoCommit} (dirty)\`:__codexBuildInfoCommit:\`unknown\`,__codexBuildInfoDistroValue=__codexBuildInfoDistro.prettyName||[__codexBuildInfoDistro.id,__codexBuildInfoDistro.versionId].filter(Boolean).join(\` \`)||\`unknown\`,__codexBuildInfoRows=[[\`Metadata file\`,codexLinuxBuildInfoValue(__codexBuildInfoPath),__codexBuildInfoPath?\`#metadata\`:null],[\`Linux package profile\`,codexLinuxBuildInfoValue(__codexBuildInfoProfile.label)],[\`Distro\`,__codexBuildInfoDistroValue],[\`Package manager\`,codexLinuxBuildInfoValue(__codexBuildInfoTarget.packageManager??__codexBuildInfoProfile.packageManager)],[\`Package format\`,codexLinuxBuildInfoValue(__codexBuildInfoTarget.packageFormat??__codexBuildInfoProfile.format)],[\`Enabled features\`,__codexBuildInfoFeatures.length>0?__codexBuildInfoFeatures.join(\`, \`):\`none\`],[\`Upstream app version\`,codexLinuxBuildInfoValue(__codexBuildInfoDmg.appVersion)],[\`Electron\`,codexLinuxBuildInfoValue(__codexBuildInfo.electronVersion)],[\`Linux source commit\`,__codexBuildInfoCommitValue,__codexBuildInfoResult.commitUrl],[\`Commit message\`,codexLinuxBuildInfoValue(__codexBuildInfoSource.commitMessage)],[\`Source branch\`,codexLinuxBuildInfoValue(__codexBuildInfoSource.branch)],[\`Generated\`,codexLinuxBuildInfoValue(__codexBuildInfo.generatedAt)],[\`Upstream DMG SHA256\`,codexLinuxBuildInfoValue(__codexBuildInfoDmg.sha256)]];return\`<!doctype html><html><head><meta charset="utf-8"><meta name="color-scheme" content="light dark"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src 'unsafe-inline'"><title>Build Information</title><style>:root{color-scheme:light dark}body{font:14px system-ui,sans-serif;margin:0;padding:28px;color:#202124;background:#fff}h1{font-size:20px;margin:0 0 20px}dl{display:grid;grid-template-columns:145px minmax(0,1fr);gap:12px 18px;margin:0}dt{color:#6b7280}dd{margin:0;min-width:0;overflow-wrap:anywhere}code,a{font:12px ui-monospace,SFMono-Regular,Consolas,monospace}a{color:#2563eb;text-decoration:underline;text-underline-offset:3px}@media(prefers-color-scheme:dark){body{color:#e8eaed;background:#202124}dt{color:#9aa0a6}a{color:#8ab4f8}}</style></head><body><h1>ChatGPT Desktop for Linux</h1><dl>\${__codexBuildInfoRows.map(__codexBuildInfoRow=>codexLinuxBuildInfoHtmlRow(...__codexBuildInfoRow)).join(\`\`)}</dl></body></html>\`}
async function codexLinuxOpenBuildInfoCommit(){let __codexBuildInfoResult=codexLinuxGetBuildInfo();return __codexBuildInfoResult.commitUrl?(await ${electronVar}.shell?.openExternal(__codexBuildInfoResult.commitUrl),{success:!0}):{success:!1}}
let codexLinuxBuildInfoWindow=null;
async function codexLinuxShowBuildInfo(){try{if(codexLinuxBuildInfoWindow&&!codexLinuxBuildInfoWindow.isDestroyed()){codexLinuxBuildInfoWindow.show(),codexLinuxBuildInfoWindow.focus();return}let __codexBuildInfoResult=codexLinuxGetBuildInfo(),__codexBuildInfoCommitUrl=__codexBuildInfoResult.commitUrl,__codexBuildInfoPath=__codexBuildInfoResult.path,__codexBuildInfoParent=${electronVar}.BrowserWindow.getFocusedWindow()??${electronVar}.BrowserWindow.getAllWindows().find(__codexBuildInfoCandidate=>__codexBuildInfoCandidate.isVisible()),__codexBuildInfoWindowOptions={width:680,height:620,minWidth:520,minHeight:420,show:!1,title:\`Build Information\`,autoHideMenuBar:!0,webPreferences:{contextIsolation:!0,nodeIntegration:!1,sandbox:!0}};__codexBuildInfoParent&&Object.assign(__codexBuildInfoWindowOptions,{parent:__codexBuildInfoParent,modal:!0}),codexLinuxBuildInfoWindow=new ${electronVar}.BrowserWindow(__codexBuildInfoWindowOptions),codexLinuxBuildInfoWindow.on(\`closed\`,()=>{codexLinuxBuildInfoWindow=null});let __codexBuildInfoOpenLink=__codexBuildInfoUrl=>{if(__codexBuildInfoCommitUrl&&__codexBuildInfoUrl===__codexBuildInfoCommitUrl){${electronVar}.shell?.openExternal(__codexBuildInfoCommitUrl);return!0}if(__codexBuildInfoPath&&__codexBuildInfoUrl.endsWith(\`#metadata\`)){${electronVar}.shell?.openPath?.(__codexBuildInfoPath);return!0}return!1};codexLinuxBuildInfoWindow.webContents.on(\`will-navigate\`,(__codexBuildInfoEvent,__codexBuildInfoUrl)=>{__codexBuildInfoOpenLink(__codexBuildInfoUrl)&&__codexBuildInfoEvent.preventDefault()}),codexLinuxBuildInfoWindow.webContents.setWindowOpenHandler(({url:__codexBuildInfoUrl})=>(__codexBuildInfoOpenLink(__codexBuildInfoUrl),{action:\`deny\`})),await codexLinuxBuildInfoWindow.loadURL(\`data:text/html;charset=utf-8,\${encodeURIComponent(codexLinuxBuildInfoDocument(__codexBuildInfoResult))}\`),codexLinuxBuildInfoWindow.show()}catch{codexLinuxBuildInfoWindow=null}}`;
}
